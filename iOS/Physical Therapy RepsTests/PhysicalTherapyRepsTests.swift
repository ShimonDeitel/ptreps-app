import XCTest
@testable import PhysicalTherapyReps

@MainActor
final class PhysicalTherapyRepsTests: XCTestCase {
    ...
    func testUpdateReplacesItem() {
        ...
        first.exerciseName = "Updated Name"
        store.update(first)
        XCTAssertEqual(store.items.first?.exerciseName, "Updated Name")
    }
